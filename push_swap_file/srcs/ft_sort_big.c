...
/*   Updated: 2024/02/07 17:53:10 by janhan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/push_swap.h"

static void	rotation(t_stack **stack, int count_from_top, int count_from_bottom)
{
	if (count_from_top == 0)
		return ;
